...
public class Ex2ShopTable extends JFrame{
	...
	public Ex2ShopTable() {
		...
		super("shop 관리"); //Frame 의 타이틀 변경
		this.setBounds(300, 100, 600, 400); // 시작 위치와 프레임 크기 설정
		this.initDesign();
	...
	public void initDesign()
	{
		...
		btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				// table 의 선택한 행 번호 가져오기
				int row=table.getSelectedRow(); //선택 안했을 경우 -1
				System.out.println(row);
				...
				su=Integer.parseInt(JOptionPane.showInputDialog("수정할 수량를 입력하세요"));
				
				//수정 메서드 호출
				shopModel.updateShop(idx, sangpum, danga, su);
				//테이블 다시 출력
				rowSelect();
			}
		});
