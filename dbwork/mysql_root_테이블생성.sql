...
-- 모든 컬럼명 생략하고 순서대로 넣기 -num 은 시퀀스 컬럼이므로 null 로 줘도 숫자로 들어간다
...
-- 각종 조회 연습
select num,name,age from person order by age asc; -- asc 생략가능 오름차순
...
select * from person where name like '_효%';
...
select * from person limit 2,3; -- 2번 부터 3개만 가져오기
