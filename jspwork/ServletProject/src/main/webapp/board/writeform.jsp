...
<br><br>
<hr>
<div style="margin-top: 20px; margin-left: 75px;width: 500px;text-align: center;" class="nologin">
		...
		<table class="tab1 table table-bordered">
			...
			<tr>
				...
				<td>
					...
					required="required" style="width: 200px;" maxlength="5"
					pattern="^[a-zA-Z0-9]+$"><!-- 최대5글자, 숫자, 영문대소문자만 가능 -->
					<!-- https://neomania.tistory.com/3 참조 -->
				</td>
			</tr>
			<tr>
