		...
		<div style="margin: 30px;">
			...
			<caption align="top"><b>사원정보수정</b></caption>
				<tr>
					<th width="100">사원명</th>
					<td>
						<input type="text" class="form-controal"
				...
				<tr>
					...
					<td class="input-group">
						...
						%>
							<option value="<%=s %>" <%=s.equals(dto.getSphoto())?"selected":"" %>>
							사진 #<%=i %>
							</option>
						<%}
						%>
				...
				<tr>
					...
					<td>
						<input type="number" name="sbirth" required="required"
						min="1900" max="2025" class="form-control" value="<%=dto.getSbirth()%>">
					</td>
				</tr>
				<tr>
					<th width="100">혈액형</th>
				...
				<tr>
					<td colspan="2" align="center">
						...
						onclick="history.back()">이전 화면</button>
					</td>
				</tr>
			</table>
		</div>
